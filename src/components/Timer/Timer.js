        ...
        <View style={{ flex: 1 }}>
            ...
            <View style={styles.MultipleBtnCon}>
                <TouchableOpacity
                    ...
                    style={[styles.BtnCon, { backgroundColor: !isActive ? '#05BEF7' : '#2697E3' }]}
                    disabled={isActive}
                >
                    <Text style={styles.BtnTxt}>Start</Text>
                </TouchableOpacity>

                <TouchableOpacity style={[styles.BtnCon, { backgroundColor: isActive ? '#05BEF7' : '#2697E3' }]} disabled={!isActive}>
